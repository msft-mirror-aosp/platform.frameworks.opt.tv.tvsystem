...
public final class PackageIoUsage {
    ...
    /**
     * Returns the number of not forgiven overuses. These are overuses that have not been attributed
     * previously to a package's recurring overuse.
     */
    public int getNotForgivenOveruses() {
        ...
        int historicalNotForgivenOveruses =
                mHistoricalNotForgivenOveruses != MISSING_VALUE
                        ...
                        : 0;
        return (mIoOveruseStats.totalOveruses - mForgivenOveruses) + historicalNotForgivenOveruses;
    }
    ...
    public boolean isExceedingThreshold() {
        ...
        android.automotive.watchdog.PerStateBytes remaining = mIoOveruseStats.remainingWriteBytes;
        return remaining.foregroundBytes == 0
                || remaining.backgroundBytes == 0
    ...
    public void dumpProto(ProtoOutputStream proto) {
        ...
        proto.write(
                PerformanceDump.IoOveruseStats.KILLABLE_ON_OVERUSE,
                mIoOveruseStats.killableOnOveruse);
        dumpPerStateBytes(
                mIoOveruseStats.remainingWriteBytes,
                PerformanceDump.IoOveruseStats.REMAINING_WRITE_BYTES,
                proto);
        ...
        dumpPerStateBytes(
                mIoOveruseStats.writtenBytes, PerformanceDump.IoOveruseStats.WRITTEN_BYTES, proto);
        proto.write(PerformanceDump.IoOveruseStats.TOTAL_OVERUSES, mIoOveruseStats.totalOveruses);
        proto.end(ioOveruseStatsToken);
        dumpPerStateBytes(
                mForgivenWriteBytes, PerformanceDump.PackageIoUsage.FORGIVEN_WRITE_BYTES, proto);
        proto.write(PerformanceDump.PackageIoUsage.FORGIVEN_OVERUSES, mForgivenOveruses);
        proto.write(
                PerformanceDump.PackageIoUsage.HISTORICAL_NOT_FORGIVEN_OVERUSES,
                mHistoricalNotForgivenOveruses);
